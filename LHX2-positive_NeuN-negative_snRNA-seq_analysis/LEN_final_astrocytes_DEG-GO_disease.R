#Cluster-specific differential gene expression (DGE) and gene ontology(GO)/pathway analysis for astrocytes in LIM Homeobox 2 (LHX2)-positive/NeuN-negative *FINAL* donor snRNA-seq dataset
#Goal: To evaluate DGE and GO terms specific to astrocyte clusters comparing APOE e2/3 Alzheimer's disease versus age-matched non-symptomatic patients.
